    ...
    <section id="projects" className="py-28 bg-[#0f0f1a] relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <div className="relative bg-[#0f0f1a] rounded-3xl overflow-hidden">
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="relative lg:w-72 h-48 lg:h-auto shrink-0 bg-[#080810] border-t lg:border-t-0 lg:border-l border-white/5">
